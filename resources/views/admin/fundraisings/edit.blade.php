    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.fundraisings.update", [$fundraising->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('donation_link') ? 'is-invalid' : '' }}" type="text" name="donation_link" id="donation_link" value="{{ old('donation_link', $fundraising->donation_link) }}" required>
