...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.fundraising.title_singular') }}
    </div>
        ...
        <form method="POST" action="{{ route("admin.fundraisings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('finished') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="finished" id="finished" value="1" {{ old('finished', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('already_collected') ? 'is-invalid' : '' }}" type="number" name="already_collected" id="already_collected" value="{{ old('already_collected', '0') }}" step="1" required>
