    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.content-categories.update", [$contentCategory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description_short') ? 'is-invalid' : '' }}" type="text" name="description_short" id="description_short" value="{{ old('description_short', $contentCategory->description_short) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $contentCategory->description) !!}</textarea>
