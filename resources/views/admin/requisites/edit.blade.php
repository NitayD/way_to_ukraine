    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.requisites.update", [$requisite->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $requisite->title) }}">
                @if($errors->has('title'))
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_link') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_link" id="is_link" value="1" {{ $requisite->is_link || old('is_link', 0) === 1 ? 'checked' : '' }}>
